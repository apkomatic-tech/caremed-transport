...
export default () => (
  <div className="site-content">
    <Container>
      <h1>
        <strong>{config.showContactForm ? 'Make an Appointment' : 'Contact Us'}</strong>
      </h1>
      <div className="contact">
        <div>
          ...
          >
            <p>
              We offer 24/7 service. We also take same-day appointments, but we recommend booking with us at least 24-48
              hours in advance.
            </p>
            <p>
        ...
        <div>
          <div className="contact-address">
            ...
            <p>
              Dispatch <a href="tel:+17142095739">(714) 209 - 5739</a>
            </p>
            <p>Fax (714) 462 - 6152</p>
            <p>
              Email: <a href="mailto:caremedtransport@gmail.com">caremedtransport@gmail.com</a>
            </p>
          </div>
