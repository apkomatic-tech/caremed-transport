...
const FORM_BASE_URI = process.env.GATSBY_FORM_BASE_URI;
const CONTACT_RETURN_URI = process.env.GATSBY_CONTACT_RETURN_URI;

console.log(FORM_BASE_URI);
	...
	render() {
		...
		return (
			<form
				className="site-form"
				method="POST"
				action={FORM_BASE_URI}
				noValidate={true}
				onSubmit={this.handleFormSubmit}
				ref={form => { this.contactForm = form }}
			>
				...
				{/* redirect */}
				<input type="hidden" name="_next" value={CONTACT_RETURN_URI} />
